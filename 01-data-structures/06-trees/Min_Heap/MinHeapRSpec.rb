...
RSpec.describe MinBinaryHeap, type: Class do
  ...
  describe "#delete(data)" do
    ...
    it "properly deletes a left node: hope" do
      tree.insert(root, hope)
      tree.delete(root, hope.title)
      expect(tree.find(root, hope.title)).to be_nil
    end

    it "properly deletes a right node: mad_max_2" do
      tree.insert(root, hope)
      tree.insert(root, mad_max_2)
    ...
    it "properly deletes a right node: jedi" do
      tree.insert(root, hope)
      tree.insert(root, pacific_rim)
      tree.insert(root, mad_max_2)
      tree.insert(root, inception)
    ...
    # it "properly deletes a left node: inception" do
    #   tree.insert(root, hope)
    #   tree.insert(root, pacific_rim)
    #   tree.insert(root, mad_max_2)
    #   tree.insert(root, inception)
